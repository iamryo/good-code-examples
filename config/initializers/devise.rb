...
Devise.setup do |config|
  ...
  config.mailer_sender = 'no-reply@phoenixhealth.com'
  ...
  # enables it only for database authentication. The supported strategies are:
  ...
  # config.pepper = '[REPLACE_WITH_REALLY_LONG_SHA]'
  ...
  # :time  = Re-enables login after a certain amount of time (see :unlock_in i
  #          below)
